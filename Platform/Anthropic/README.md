...
이 폴더는 Anthropic 계열 환경(예: Claude Code)에서 이 스킬 세트를 사용할 때 필요한 플랫폼별 운영 파일을 분리해서 관리하는 공간입니다.
...
전용 CLI 유무나 실제 호출 방식이 헷갈리면 공통 안내 문서인 [USAGE_FAQ.md](../../USAGE_FAQ.md)를 먼저 확인하세요.
