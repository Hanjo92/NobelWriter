...
- 같은 스킬 자산을 여러 Google 환경에 맞게 재사용
...
- [Antigravity](./Antigravity)
  - Google DeepMind의 Antigravity 에이전트 환경용 운영 파일
...
- Antigravity를 쓸 때
  - `Platform/Google/Antigravity/README.md`부터 확인

## 메모

앞으로 Google 계열의 다른 환경이 추가되면 같은 방식으로 하위 폴더를 늘립니다.
