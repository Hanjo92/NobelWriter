...
Treat these as extract-first items:

- named relationships and their latest status
- injuries, recoveries, deaths, absences
- object ownership and location
- world rules, limits, prices, taboos
- public truths versus hidden truths
...
2. character state and motivation
3. knowledge and misinformation
4. object, place, and faction state
5. payoff debt and dropped promises
