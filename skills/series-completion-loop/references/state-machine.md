...
- machine-checkable runtime fields are `last_completed_transition`, `last_artifact_pointer`, `last_proof_predicate`, `specialist_return_accepted`, `last_valid_boundary`, `last_snapshot_paths`, and `last_mismatch_evidence`
