# Sample Serialization QA Report

Use this file when you want a completed example focused on episode-by-episode fiction.

## Example

```text
Audit scope:
- Manuscript range: Episodes 86-95
- Planning documents checked: rolling arc outline, episode hook notes, payoff tracker
- Audit mode: arc checkpoint
- Sampling limit: full read of Episodes 86-95, spot check of Episodes 82-85 for setup context

Complaint under test:
- Reported symptom: recent episodes still get clicks, but reader comments say the payoff feels thin and the chapters feel samey
- Working hypothesis: end-hook repetition and delayed consequence are weakening trust even when retention bait remains active

Scope note:
- What was checked: episode-end hooks, next-episode consequence carryover, recap burden, active setup threads
- What was not checked: full-season structure before Episode 82, prose-level voice polish
- Confidence limit: high confidence for hook-to-payoff behavior in Episodes 86-95, medium confidence for earlier setup imbalance
...
- The weakening reward cadence may originate in the previous arc handoff around Episodes 79-82, but the current sample is not wide enough to confirm the exact onset.

What is still working:
- The antagonist faction remains legible and consistently threatening.
...
- It separates retention-facing strength from story-health weakness.
- It shows how serial hooks can function commercially while still failing as story design.
- It uses recheck conditions tied to episode behavior, not to vague improvement claims.
